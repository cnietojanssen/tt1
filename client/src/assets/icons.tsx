...
export function LogoIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M9 17.5L14 22.5L23 11.5" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}

export function QRCodeIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
